...
public class TestServicio {
	...
	public void setUp() throws Exception {
		...
		s1 = new Servicio(001, "2-5-2023",6300,"Bilbao", "Barcelona", 50 , TipoServicio.vuelo ,96);
		s2 = new Servicio(932, "04-11-2022",3000,"Santander", "Valencia", 45, TipoServicio.bus, 45);
		s3 = new Servicio("30-08-2024",TipoServicio.viajeCombinado);
		s4 = new Servicio();
	...
	public void testConstructorConParametros() {
		...
		assertEquals("2-5-2023", s1.getFecha());
	...
	public void testConstructorFechaTipoServicio() {
		assertEquals("30-08-2024", s3.getFecha());
...
//	}
	...
	public void testSetFecha() {
		...
		try {
			s1.setFecha("20/03/2040");
			assertEquals("20/03/2040", s1.getFecha());
